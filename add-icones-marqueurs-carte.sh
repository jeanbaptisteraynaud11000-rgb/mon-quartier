#!/usr/bin/env bash
set -e
echo "Icones emoji par categorie sur les marqueurs de la carte..."
...
echo "Icones marqueurs ajoutees avec succes."
echo "Prochaine etape : git add -A && git commit -m \"carte : icones emoji par categorie exacte\" && git push"