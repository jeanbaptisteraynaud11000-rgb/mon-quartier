#!/usr/bin/env bash
set -e
echo "Uniformisation des cartes accueil (4 max + voir plus)..."
...
echo "Accueil uniformise avec succes."
echo "Prochaine etape : git add -A && git commit -m \"accueil : cartes uniformes + voir plus\" && git push"